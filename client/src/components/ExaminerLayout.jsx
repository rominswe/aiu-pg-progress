...
import { LayoutDashboard, FileCheck, Menu, X, LogOut, Bell, User } from 'lucide-react';

export default function ExaminerLayout({ children, onLogout }) {
  ...
  const navigation = [
    ...
    { name: 'Evaluations', href: '/examiner/evaluations', icon: FileCheck },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <aside className={`fixed top-0 left-0 z-50 h-screen w-64 bg-white shadow-lg transform transition-transform duration-300 lg:translate-x-0 ${
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h1 className="text-xl font-bold text-gray-800">Examiner Portal</h1>
          <button
            onClick={() => setSidebarOpen(false)}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 transition-all cursor-pointer">
                ...
                <div className="hidden sm:block">
                  <p className="text-sm font-semibold text-gray-800">Examiner</p>
